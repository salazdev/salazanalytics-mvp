...
def show():
    ...
    uploaded = st.file_uploader(
        "Arrastra un Excel (.xlsx) o PDF aquí",
        type=["xlsx", "xls", "pdf"],
    ...
    for col, n, t, d in [
        ...
        (s3, "3", "Visualiza resultados", "Gráficas interactivas con Plotly"),
        (s4, "4", "Exporta tu reporte",   "PDF profesional listo para presentar"),
    ]:
        with col:
            st.markdown(f"""
            <div style="background:#0a1520;border:1px solid #1a3a5c;border-radius:10px;padding:1rem;text-align:center;">
