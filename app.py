...
def mostrar_logo(width=220):
    with open(Path(__file__).parent / "logo-salazanalytics.png", "rb") as f:
        ...
        <div style="text-align:center;margin-top:1rem;">
            <p style="color:#7B9BB5;font-size:.8rem;">
                ...
                <a href="https://salazanalytics.com/contacto" target="_blank"
                   style="color:#00C2FF;text-decoration:none;">Solicita acceso aqui</a>
            </p>
        </div>
        """, unsafe_allow_html=True)
...
def app_principal():
    ...
    if   "Inicio"       in page: load_module("home", base/"_home.py").show()
      ...
      st.write(f"Existe: {(base / '_pdf_ia.py').exists()}")
